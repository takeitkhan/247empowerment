...
class TranslationString
{
    public static function getAdminI18n()
    {
        $i18n = array(
            ...
            __('Share your form by unique URL (Pro) or copy and paste the %1$sshortcode%2$s to embed in your page and post', 'fluentform'),
    ...
    public static function getSettingsI18n()
    {
        $i18n = array(
            ...
            'How country based restriction works' => __('How country based restriction works', 'fluentform'),
            'Blocks or allows a submission based on the country the visitor submits from.' => __('Blocks or allows a submission based on the country the visitor submits from.', 'fluentform'),
            'The country comes from the visitor IP address: ipinfo.io first when a GEO API token is saved in Global Settings, then apip.cc.' => __('The country comes from the visitor IP address: ipinfo.io first when a GEO API token is saved in Global Settings, then apip.cc.', 'fluentform'),
            'CDN or server country headers are a last resort, off by default because a visitor can fake them. Only enable this behind a CDN that overwrites them:' => __('CDN or server country headers are a last resort, off by default because a visitor can fake them. Only enable this behind a CDN that overwrites them:', 'fluentform'),
            'If no country is found, \'Fail the submission if match\' lets it through and \'Allow the submission if match\' blocks it.' => __('If no country is found, \'Fail the submission if match\' lets it through and \'Allow the submission if match\' blocks it.', 'fluentform'),
            ...
            'Choose the countries this rule applies to.' => __('Choose the countries this rule applies to.', 'fluentform'),
    ...
    public static function getGlobalSettingsI18n()
    {
        $i18n = array(
            ...
            'Manage updates and support for Fluent Forms Pro.' => __('Manage updates and support for Fluent Forms Pro.', 'fluentform'),
            'Active' => __('Active', 'fluentform'),
            'Disabled' => __('Disabled', 'fluentform'),
            'Invalid' => __('Invalid', 'fluentform'),
            'Error' => __('Error', 'fluentform'),
            'Expired' => __('Expired', 'fluentform'),
            'Grace Period' => __('Grace Period', 'fluentform'),
            'Needs Verification' => __('Needs Verification', 'fluentform'),
            'Not Activated' => __('Not Activated', 'fluentform'),
            'Expires' => __('Expires', 'fluentform'),
            'Lifetime' => __('Lifetime', 'fluentform'),
            'Subscription' => __('Subscription', 'fluentform'),
            'Licensed To' => __('Licensed To', 'fluentform'),
            'Updates & Support' => __('Updates & Support', 'fluentform'),
            'Ending soon' => __('Ending soon', 'fluentform'),
            'Last checked' => __('Last checked', 'fluentform'),
            'Refresh' => __('Refresh', 'fluentform'),
            'Your Account' => __('Your Account', 'fluentform'),
            'Get Support' => __('Get Support', 'fluentform'),
            'Manage Subscription' => __('Manage Subscription', 'fluentform'),
            'Deactivate' => __('Deactivate', 'fluentform'),
            'Activate a different license key' => __('Activate a different license key', 'fluentform'),
            'Enter your Fluent Forms Pro license key' => __('Enter your Fluent Forms Pro license key', 'fluentform'),
            'The key you enter replaces the one this site currently uses.' => __('The key you enter replaces the one this site currently uses.', 'fluentform'),
            'Activate your license to receive automatic updates and premium support.' => __('Activate your license to receive automatic updates and premium support.', 'fluentform'),
            'Verify License' => __('Verify License', 'fluentform'),
            "Don't have a license key?" => __("Don't have a license key?", 'fluentform'),
            'Purchase one here' => __('Purchase one here', 'fluentform'),
            'Have a new license key?' => __('Have a new license key?', 'fluentform'),
            'Click here' => __('Click here', 'fluentform'),
            'Renew License' => __('Renew License', 'fluentform'),
            'Your license has expired.' => __('Your license has expired.', 'fluentform'),
            'Everything keeps working during the grace period. Renew now to keep updates and support.' => __('Everything keeps working during the grace period. Renew now to keep updates and support.', 'fluentform'),
            'Renew your license to keep receiving updates and support.' => __('Renew your license to keep receiving updates and support.', 'fluentform'),
            'We could not verify this license.' => __('We could not verify this license.', 'fluentform'),
            'This saved license needs to be verified.' => __('This saved license needs to be verified.', 'fluentform'),
            'Refresh the status. Your existing key remains saved if the license server is unavailable.' => __('Refresh the status. Your existing key remains saved if the license server is unavailable.', 'fluentform'),
            'The license status could not be loaded.' => __('The license status could not be loaded.', 'fluentform'),
            'Your license was activated successfully.' => __('Your license was activated successfully.', 'fluentform'),
            'The license could not be activated.' => __('The license could not be activated.', 'fluentform'),
            'This site will stop receiving plugin updates until a license is activated again.' => __('This site will stop receiving plugin updates until a license is activated again.', 'fluentform'),
            'Deactivate this license?' => __('Deactivate this license?', 'fluentform'),
            'Yes, Deactivate' => __('Yes, Deactivate', 'fluentform'),
            'Your license was deactivated successfully.' => __('Your license was deactivated successfully.', 'fluentform'),
            'The license could not be deactivated.' => __('The license could not be deactivated.', 'fluentform'),
            'Fluent Forms Lite does not require a license.' => __('Fluent Forms Lite does not require a license.', 'fluentform'),
            'Upgrade to Fluent Forms Pro for premium features, automatic updates and support.' => __('Upgrade to Fluent Forms Pro for premium features, automatic updates and support.', 'fluentform'),
            /* translators: %d: number of days. */
            'expired %d days ago' => __('expired %d days ago', 'fluentform'),
            'expires today' => __('expires today', 'fluentform'),
            'in 1 day' => __('in 1 day', 'fluentform'),
            /* translators: %d: number of days. */
            'in %d days' => __('in %d days', 'fluentform'),
    ...
    public static function getEditorI18n()
    {
        $i18n = array(
            ...
            'You have to have at least one option.' => __('You have to have at least one option.', 'fluentform'),
            'You have to have at least two options.' => __('You have to have at least two options.', 'fluentform'),
            'Bulk Edit cannot be applied to grouped options.' => __('Bulk Edit cannot be applied to grouped options.', 'fluentform'),
    ...
    public static function getPaymentsI18n()
    {
        $i18n = array(
            ...
            'partially-refunded' => __('partially-refunded', 'fluentform'),
            'active' => __('active', 'fluentform'),
